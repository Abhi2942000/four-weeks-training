namespace StackApp
{
    internal class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            CustomStack<Abhi> stack3 = new CustomStack<Abhi>();
            stack3.Push(new Abhi(1));
            stack3.Push(new Abhi(2));
            stack3.Push(new Abhi(3));
            stack3.Push(new Abhi(4));
            stack3.Push(new Abhi(5));
            stack3.Push(new Abhi(6));
